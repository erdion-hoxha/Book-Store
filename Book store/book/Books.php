    ...
    <div class="sidebar">
        <div class="scrollbar-inner sidebar-wrapper">
            <div class="user">
                ...
                <div class="info">
                    <a class="" data-toggle="collapse" data-target="#collapseExample">
                        <span>
                            Hizr
                    ...
                    <div class="collapse" id="collapseExample">
                        <ul class="nav">
                            <li>
                                <div class="btn btn-info">Log Out</div>
                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            ...
                            <i class="material-icons"></i> <span>Add New Book</span>
                                    ...
                                    <a href="#addBookModal" id="add-book-button" class="btn btn-success" data-toggle="modal" data-target="#addBookModal"><i class="material-icons"></i> <span>Add New Book</span></a>
